    ...
    function startMap() {
       ...
       var defaultLatLng
        ...
        function setupEventHandlers() {
            ...
            /*CLick event*/
            jQuery(document).on("click",".store-toggler",function(){
            
                if(jQuery(this).siblings('.store-content').hasClass('open')){
                    jQuery(this).siblings('.store-content').removeClass('open').slideUp('slow');
                    jQuery('.store-toggler').removeClass('open');
                    jQuery(this).removeClass('open');
                }
                else{
                    jQuery('.store-content').removeClass('open').slideUp('slow');
                    jQuery('.store-toggler').removeClass('open');
                    jQuery(this).siblings('.store-content').addClass('open').slideDown('slow');
                    jQuery(this).addClass('open');
                    var store_id = jQuery(this).siblings('.store-content').attr('id');

                    var $targetStore = jQuery('#'+store_id);
        ...
        if(_store.telephone!=''){
         ...
         _store.fax='<a href="tel:'+ _store.fax+'">'+ _store.fax+'</a>';
            ...
            return [
                ...
                '<div class="medium-4', clearClass, ' ssf-column store-list-item ">',
                    '<div class="arrow-toggler store-toggler">',_store.location,'</div>',


                    '<div class="store-locator__infobox store-content" id="store', index, '">',



                        '<div class="infobox__row infobox__row--marker" style="display:none;">',
                        ...
                        '<div class="infobox__row infobox__title   store-image"  style="display:none;">',
                            ...
                            '<div class="infobox__row   store-address" style="display:none;">',
...
jQuery("#storeLocatorMap").on("click", function(e){
  if( e.target.class != 'infoBox') {
    jQuery(".infoBox").hide();
  }
});
...
jQuery("#toogle_btn").on("click", function(e){
    ...
    if (jQuery('#toogle_btn').hasClass('active')){
        ...
        jQuery('#toogle_btn').animate({left:'0px'},{ duration: 1000, easing: "linear"});       
        
        jQuery('#super-left-panel').animate({left:'-350px'},{ duration: 1000, easing: "linear"});
        jQuery('#storeLocatorMap').animate({left:'0px', width:'100%'},{ duration: 1000, easing: "linear"});       
        ...
        jQuery('#toogle_btn').animate({left:'350px'},{ duration: 1000, easing: "linear"});       

        jQuery('#super-left-panel').animate({left:'0px'},{ duration: 1000, easing: "linear"});
        jQuery('#storeLocatorMap').animate({left:'350px',width: "calc(100% - 350px)"},{ duration: 1000, easing: "linear",complete: function(){jQuery('#storeLocatorMap').addClass('map-fix');}});       
...
function go_to_page(page_num){
    ...
    var topOffset=jQuery("#ssf-anchor").offset().top-100;

    if(ssf_pan_by_map=='true'){

        jQuery("body").animate({scrollTop:topOffset}, 'slow');
...
/*jQuery(document).on("click",".store-toggler",function(){
    jQuery('.store-content').hide();
    jQuery(this).siblings('.store-content').slideToggle();
