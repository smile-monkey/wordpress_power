...
$ssf_wp_mdo[] = array("field_name" => "scroll_to_top", "default" => "0", "input_zone" => "defaults", "label" => __("Scroll to top", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='number' name='scroll_to_top' value=\"$ssf_wp_vars[scroll_to_top]\" size='14'>");

$scroll_setting="";
$scroll_condition["".__("On", SSF_WP_TEXT_DOMAIN).""]="true";
$scroll_condition["".__("Off", SSF_WP_TEXT_DOMAIN).""]="false";
